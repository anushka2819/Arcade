...
import { Play, RotateCcw, BarChart3, Volume2, Moon, Sparkles, Check } from 'lucide-react';
import { sounds } from '../SoundEffects';

export function Screen_PlushMatch({
  onBackToArcade,
  onPlayMiniGame,
  isAudioOn,
  setIsAudioOn,
      ...
      <main className="w-full bg-white/80 backdrop-blur-md rounded-3xl p-6 sm:p-8 lg:p-10 border border-zen-pinkAccent/40 shadow-zen flex flex-col justify-between">
        <div>
          <div className="flex flex-col items-center text-center mb-8">
            <div className="relative rounded-2xl overflow-hidden mb-4 shadow-sm h-40 w-full max-w-md bg-white/80 border border-zen-yellow/50 flex items-center justify-center p-3">
              <img src="/assets/feeling_fusion/fusion_bg.svg" alt="Feeling Fusion" className="max-h-full max-w-full object-contain drop-shadow-sm" />
            </div>
            ...
            <p className="text-xs sm:text-sm text-zen-mauve mt-1.5 max-w-md">
              Blend primary emotions together and discover what your feelings are trying to say.
            </p>
          </div>
          ...
          <div className="max-w-md mx-auto mb-8">
            <button
              onClick={() => {
                ...
                onPlayMiniGame({
                  ...
                  description: 'Blend primary emotions together!'
                });
              }}
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              <button
                onClick={() => {
                  ...
                  onPlayMiniGame({
                    id: 'feeling_fusion',
                    title: 'Feeling Fusion',
                    description: 'Start fresh emotion synthesis.'
                  });
                }}
              ...
              <button
                onClick={() => alert("Fusion Stats:\n- Syntheses Unlocked: 12\n- Emotional Harmony Level: Max\n- Calm Points: 950")}
                className="py-2.5 px-4 rounded-xl bg-zen-pinkLight border border-zen-pinkAccent text-zen-plum font-bold text-xs hover:bg-zen-pinkCard transition-all flex items-center justify-center gap-2"
              >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-zen-mauve">Background audio chimes</p>
                  </div>
                </div>
                <button
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-zen-mauve">Soft dark lighting</p>
                  </div>
                </div>
                <button
