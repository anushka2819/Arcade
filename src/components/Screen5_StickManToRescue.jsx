      ...
      <main className="w-full bg-white/80 backdrop-blur-md rounded-3xl p-6 sm:p-8 lg:p-10 border border-zen-pinkAccent/40 shadow-zen flex flex-col justify-between relative overflow-hidden">
        ...
        <div>
          ...
          <div className="flex flex-col items-center text-center mb-8">
            <div className="relative rounded-2xl overflow-hidden mb-4 shadow-sm h-40 w-full max-w-md bg-white/80 border border-zen-creamBg flex items-center justify-center p-3">
              <img src="/stickman_assets/stickman_group.svg" alt="Stick Man to the Rescue" className="max-h-full max-w-full object-contain drop-shadow-sm" />
            </div>
